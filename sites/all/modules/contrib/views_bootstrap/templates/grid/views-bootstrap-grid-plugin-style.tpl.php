  ...
  <?php if ($options['alignment'] == 'horizontal'): ?>
    ...
    <?php foreach ($items as $row): ?>
        <?php foreach ($row['content'] as $column): ?>
          <div class="grid-item col col-lg-<?php print $lg_column_type ?> col-md-<?php print $md_column_type ?> col-sm-<?php print $sm_column_type ?> col-xs-<?php print $xs_column_type ?>">
